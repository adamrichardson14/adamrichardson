        ...
        <div className="mt-8">
          ...
          <div className="text-2xl font-medium text-gray-300 mt-8 leading-10">
            ...
            <p className="mt-4">
              ...
              on. Below you will see my tech stack which is what you can expect to see courses on in
            ...
            <h2 className="text-2xl font-bold leading-7 text-white sm:text-3xl mt-8 underline">
              Stack
            </h2>
            <h3 className="text-xl font-bold leading-7 text-gray-200 sm:text-2xl mt-2">Frontend</h3>
            <p>
              I've been working with React for a number of years now and will use it for pretty much
              every project. Next.js is my favourite React framework and I use Tailwindcss for
              styling websites. For smaller individual projects I will use Javascript over
              Typescript.
            </p>
            <h3 className="text-xl font-bold leading-7 text-gray-200 sm:text-2xl mt-2">Backend</h3>
            <p>
              This one is dependant on the project and this changes quite a lot. For simple projects
              I've used a lot of headless CMS's and I feel my favourite is Sanity. I enjoy using
              Strapi and Keystone too.
            </p>
            <p>
              For more complex integrations I would integrate with my own database via an API. I've
              extensively used MySQL and Postgres, along with Mongodb and Firebase Firestore. For
              data that isn't heavily relational I would probably opt for either Firebase or Mongodb
              depending on complexiy. For relational data I would definitely go with Postgres.
            </p>
            <h2 className="text-2xl font-bold leading-7 text-white sm:text-3xl mt-8 underline">
              Full Stack
            </h2>
            <div className="prose prose-2xl prose-dark">
              ...
              <ul>
                ...
                <li>Postgres (AWS)</li>
                <p className="text-base text-gray-300">Postgres DB hosted on AWS RDS.</p>
